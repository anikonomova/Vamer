...
class Info extends Component {
  render() {
    return (
      <div className="info">
      <div className='about'>
      <p>Фирма Вамер е Българска компания в областта на изграждането на системи за наливни напитки
      – газирани, негазирани , алкохолни , безалкохолни – с охлаждане или без охлаждане.</p>
<ul>
<li>бира</li>
<li>вино</li>
